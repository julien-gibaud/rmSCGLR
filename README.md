...
## Simulations from the paper ([Gibaud et al. 2024](#ref-gibaud22))
### Simulation 1
```r
library(rmSCGLR)
library(mvtnorm)
...
Gibaud J, Bry X, Trottier C, Mortier F and Réjou-Méchain M. Response mixture models based on supervised components: Clustering floristic taxa. *Statistical Modelling*. 2024;24(3):226-244. doi:10.1177/1471082X221115525

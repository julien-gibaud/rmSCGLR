...
Gibaud J., Bry X., Trottier C., Mortier F. and Réjou-Méchain M., (2022), ``Response mixture models based on supervised components: Clustering floristic taxa'', *to be submitted soon*
